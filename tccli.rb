...
class TencentcloudCli < Formula
  include Language::Python::Virtualenv
  desc "Tencent Cloud API 3.0 Command Line Interface"
  homepage "https://github.com/TencentCloud/tencentcloud-cli"
  url "https://github.com/TencentCloud/tencentcloud-cli/archive/3.0.319.1.tar.gz"
  sha256 "9adff8feb7e40d1327ec37da0a0ab7b41773c3bac09d1f7fdba329ba3cf5e756"
  license "Apache-2.0"
